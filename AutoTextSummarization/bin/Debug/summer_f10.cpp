...
void basic_in_map(char article_type[])
{
    ...
    else if(strcmp(article_type,"type1")==0)
         input.open(".\\type1.txt");
     else if(strcmp(article_type,"type2")==0)
         input.open(".\\type2.txt");
      else if(strcmp(article_type,"type3")==0)
         input.open(".\\type3.txt");
       else if(strcmp(article_type,"type4")==0)
         input.open(".\\type4.txt");
        else if(strcmp(article_type,"type5")==0)
         input.open(".\\type5.txt");
    while(!input.eof())
    {
                       checkarray[0]='\0';
...
void extractword(line* ptr,char article_type[])
{
    ...
    if(strcmp(article_type,"general")==0)
        input.open(".\\common_words.txt",ios::app);
         ...
         input.open(".\\type1.txt",ios::app);
     else if(strcmp(article_type,"type2")==0)
         input.open(".\\type2.txt",ios::app);
      else if(strcmp(article_type,"type3")==0)
         input.open(".\\type3.txt",ios::app);
       else if(strcmp(article_type,"type4")==0)
         input.open(".\\type4.txt",ios::app);
        else if(strcmp(article_type,"type5")==0)
         input.open(".\\type5.txt",ios::app);
